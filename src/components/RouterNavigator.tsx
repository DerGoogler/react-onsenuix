...
class RouterNavigator extends React.Component<RouterNavigatorProps> {
   ...
   */
  private resetPageStack(routes: any[], options = {}): Promise<any> | undefined {
    if (this.isRunning()) {
      return;
    }
   ...
   */
  private replacePage(route: any[], options = {}) {
    if (this.isRunning()) {
      return;
    }
   ...
   */
  private popPage(options = {}): Promise<any> | undefined {
    if (this.isRunning()) {
      return;
    }
